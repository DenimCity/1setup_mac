...
brew cask install flycut google-chrome slack gitkraken spectacle visual-studio-code mongodb-compass postman intellij-idea android-studio microsoft-office
